  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        warning: "bg-yellow-500 text-white shadow-sm hover:bg-yellow-600 active:scale-[0.98]",
      },
      size: {
    ...
    return (
      <Comp
        className={cn(
          ...
          "after:content-[''] after:absolute after:inset-0 after:bg-white/10 after:opacity-0 after:transition-opacity after:duration-200",
